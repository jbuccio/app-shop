    ...
    <div class="section text-center section-landing">
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <h5 class="description">Puedes revisar nuestar relacion completa de productos, compara precios y realizar tus pedidos cuando estes seguro.</h5>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="info">
              ...
              <p>Los pedidos que realices solo los conoceras tu traves de tu panel de usuario. Nadie mas tiene acceso a esta informacion.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    $(function () {
      ...
      var products = new Bloodhound({
        ...
        // `products` is an array of state names defined in "The Basics"
